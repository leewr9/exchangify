...
function updateMainDataContent(exchangeData) {
  ...
  updateRateElement(
    todayRateElement,
    exchangeData.today_deal_bas_r,
    exchangeData.today_cur_date,
  );
  ...
  updateRateElement(
    minRateElement,
    exchangeData.min_deal_bas_r,
    exchangeData.min_cur_date,
  );
  ...
  updateRateElement(
    maxRateElement,
    exchangeData.max_deal_bas_r,
    exchangeData.max_cur_date,
  );
